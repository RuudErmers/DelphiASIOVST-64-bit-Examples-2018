...
const
{$IFDEF CPU64 }
  bassdll = 'c:\midi\bass\bass64.dll';
{$else }
  bassdll = 'c:\midi\bass\bass32.dll';
{$endif }
...
function BASS_PluginLoad(filename: PAnsiChar; flags: DWORD): HPLUGIN; stdcall; external bassdll;    // Changed by Ruud !!
